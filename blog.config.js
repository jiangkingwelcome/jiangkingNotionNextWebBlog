...
const BLOG = {
  ...
  THEME: process.env.NEXT_PUBLIC_THEME || 'modern-weibo', // 当前主题，在themes文件夹下可找到所有支持的主题；主题名称就是文件夹名，例如 example,fukasawa,gitbook,heo,hexo,landing,matery,medium,next,nobelium,plog,simple,modern-weibo
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Jiangking', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '叫我king哥', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://tangly1024.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Jiangking, 博客', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'jiangkingwelcome@vip.qq.com', // 邮箱地址 例如mail@tangly1024.com
